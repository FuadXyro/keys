...
(e = function () {
  ...
  var i = (e.navigator || {}).userAgent,
    ...
    d = (~c.indexOf("MSIE") || c.indexOf("Trident/"), []),
    m = !1;
  function g(e) {
    f && (m ? setTimeout(e, 0) : d.push(e));
  }
  f &&
    ((m = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      u.readyState
    )) ||
                ...
                (s = p(
                  (s = p(
                    ...
                    (f = p(
                      ...
                      (l = p(
                        l,
                        (a = p(a, s, f, l, e[n + 12], 6, 1700485571)),
                        s,
                        f,
                        e[n + 3],
                        10,
                  ...
                  (f = p(
                    ...
                    (l = p(
                      l,
                      (a = p(a, s, f, l, e[n + 8], 6, 1873313359)),
                      s,
                      f,
                      e[n + 15],
                      10,
              ...
              function (n, o, r, i) {
                parent.FontAwesomeDetection.__pollUntil({
                  fn: function () {
                    ...
                    return !(
                      !t.match(/FontAwesome/) && !t.match(/Font Awesome [56]/)
                    );
                  },
                })
                  .then(function () {
  ...
  !(function (e) {
    ...
    s && f && F(window.FontAwesomeDetection.report);
  });
}),
