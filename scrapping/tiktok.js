...
var qs = require("../controller/querystring");
  ...
  async getHashtagVideo(tag) {
    ...
    for (let i = 0; i < data.length; i++) {
      result.push({
        ...
        likes: functions.h2k(data[i].stats.diggCount),
        shared: functions.h2k(data[i].stats.shareCount),
        comments: functions.h2k(data[i].stats.commentCount),
        playCount: functions.h2k(data[i].stats.playCount),
      ...
      axios
        ...
        .then(({ data }) => {
          ...
          const result = {
            ...
            views: functions.h2k($("ul.video-stats > li > span").text().trim()),
